...
**Date:** 2026-01-18T13:12:14.610153  
**Dataset:** v2.0  
**Total Queries:** 3
...
| Avg Latency | 4595ms | < 2000.0ms | ❌ FAIL |
| **Overall** | - | - | ❌ **FAIL** |
...
- **High Latency (4595ms)**: Exceeds SLA. Optimize FAISS search, reduce LLM token usage, or use caching.
