...
STATUS: Active
RESPONSIBILITY: Unit tests for data processing and enrichment functions.
...
- src.data.processor: Data processing functions
...
def test_process_record_success(processor: EventProcessor, sample_record: dict) -> None:
...
def test_process_records_multiple(processor: EventProcessor, sample_record: dict) -> None:
