"""Tests for clarifications.py - Clarification question templates."""

import pytest
from src.retrieval.clarifications import (
    ...
    def test_all_templates_have_required_fields(self):
        ...
        for reason, templates in CLARIFICATION_QUESTIONS.items():
            for lang in ["fr", "en"]:
                ...
                assert isinstance(template["questions"], list), f"Questions must be a list"
    ...
    def test_bilingual_question_count_matches(self):
        ...
        for reason, templates in CLARIFICATION_QUESTIONS.items():
            ...
            assert fr_count == en_count, \
                f"Question count mismatch for '{reason}': FR={fr_count}, EN={en_count}"
