"""Integration tests to catch dead/unused code.

These tests verify that:
1. All prompt getter functions return valid prompts
2. All chains defined in RAGChain are actually used
3. All imports in key modules are actually used
4. End-to-end query pipeline works correctly
"""
