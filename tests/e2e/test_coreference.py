"""
FILE: test_coreference.py
STATUS: Active
RESPONSIBILITY: E2E tests for coreference resolution using previous events context from chat history.

DEPENDENCIES (Who uses this file):
- pytest test runner
- Manual testing of multi-turn conversations
