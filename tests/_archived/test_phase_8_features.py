"""
FILE: test_phase_8_features.py
STATUS: Active
RESPONSIBILITY: Integration tests for Phase 8 features (circuit breaker, security, monitoring).
...
- src.security.guardrails: Security checks, src.generation.llm: Circuit breaker
