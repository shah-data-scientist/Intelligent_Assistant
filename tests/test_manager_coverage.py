"""Tests for the multi-stage RetrievalManager."""
...
def mock_vs():
    ...
    def get_coords(city):
        if city.lower() == "paris": return (48.8566, 2.3522)
        if city.lower() == "poissy": return (48.9298, 2.0441)
        return None
...
class TestRetrievalManager:
    ...
    def test_execute_search_phase_2_nearby(self, mock_vs):
        ...
        mock_vs.search.side_with_args = {
            "metadata_filter": {"city": "Paris", "month": 2, "year": 2026}
        }
