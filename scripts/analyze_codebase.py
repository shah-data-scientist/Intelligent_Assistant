...
STATUS: Active
RESPONSIBILITY: Analyze Python codebase for dead code, unused imports, and refactoring opportunities.

DEPENDENCIES (Who uses this file):
- Manual developer usage for code quality analysis

IMPORTS (What this file needs):
- ast: Parse Python source code into AST
...
def main():
    ...
    if large_files:
        ...
        for result in large_files[:10]:
            print(f"   FILE: {result['filepath']}")
            print(
                f"      {result['lines']} lines, {result['function_count']} functions, {result['class_count']} classes"
            )
        print()
