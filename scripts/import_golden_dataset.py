                ...
                # Nested fields
                    ...
                    if match:
                        ...
                        # Handle ground truth items
                            ...
                            current_list == "relevance_ground_truth"
                            and len(current_query.get("relevance_ground_truth", [])) > 0
                        ):
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Import edited YAML golden dataset back to JSON")
    parser.add_argument("--input", default="data/evaluation/golden_dataset.yaml", help="Input YAML file path")
    parser.add_argument("--output", default="data/evaluation/golden_dataset.json", help="Output JSON file path")
    parser.add_argument("--no-backup", action="store_true", help="Skip creating backup of existing JSON")
