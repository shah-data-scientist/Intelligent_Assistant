...
def trace_query(query: str, chat_history=None):
    ...
    print("  Suffix preview (if results found):")
    ...
    print("  Response = [PREFIX] + [RAG_ANSWER] + [SUFFIX]")
    print("\n  Where:")
    print(f"    PREFIX = \"{prefix or '(none)'}\"")
    print("    RAG_ANSWER = (generated by LLM based on retrieved events)")
    print("    SUFFIX = (refinement suggestions)")
...
if __name__ == "__main__":
    ...
    print("# (Follow-up: should keep jazz/Paris, add February)")
    print("#" * 80)
    ...
    print("\n  Expected behavior:")
    print("    - City: Paris (preserved from Turn 1)")
    print("    - Category: jazz/concert (preserved from Turn 1)")
    print("    - Month: 2 (February - added in Turn 2)")
