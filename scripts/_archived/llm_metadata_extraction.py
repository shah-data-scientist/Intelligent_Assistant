...
class MetadataExtractor:
    def __init__(self):
        ...
        self.prompt = ChatPromptTemplate.from_messages([("system", EXTRACTION_SYSTEM_PROMPT)])
...
async def main(limit=None):
    ...
    targets = [
        e for e in events if e.scraped_content and (e.age_min is None or not e.conditions or e.conditions == "unknown")
    ]
