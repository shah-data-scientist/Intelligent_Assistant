...
def main():
    ...
    parser = argparse.ArgumentParser(description="Audit database quality for RAG optimization")
    parser.add_argument(
        "--output", default="data/evaluation/data_quality_report.json", help="Output path for JSON report"
    )
