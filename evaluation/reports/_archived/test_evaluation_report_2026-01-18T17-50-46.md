...
**Date:** 2026-01-18T17:50:46.682829
**Dataset:** v2.0
**Total Queries:** 3
...
|--------|-------|-----------|--------|
| Quality Score | 0.433 | ≥ 0.8 | ❌ FAIL |
| Avg Latency | 32339ms | < 2000.0ms | ❌ FAIL |
| **Overall** | - | - | ❌ **FAIL** |
...
- **High Latency (32339ms)**: Exceeds SLA. Optimize FAISS search, reduce LLM token usage, or use caching.
