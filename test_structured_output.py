"""Test Pydantic structured output with Gemini.

This script tests the Phase 2 changes:
1. UnifiedAnalyzer creates structured_llm with with_structured_output()
2. analyze() method uses structured output when use_structured_output=True
3. Pydantic schema is correctly converted to dict format
"""
...
def test_structured_output():
    ...
    safe_print(f"[INFO] Analyzer initialized")
    ...
    for i, query in enumerate(test_queries, 1):
        ...
        try:
            ...
            if statistical and statistical.detected:
                safe_print(f"[OK] Statistical query detected")
